            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-contact">
                    ...
                    <p>
                        ...
                        <strong>Telepon:</strong> +628 1396080977<br>
                ...
                <div class="col-lg-2 col-md-6 footer-links">
                    <h4>Useful Links</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('tentangdesa.user') }}">Tentang Desa</a>
                        </li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('sejarahdesa.user') }}">Sejarah Desa</a>
                        </li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('visimisi.user') }}">Visi Misi</a>
                        </li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('geografis.user') }}">Geografis</a>
                        </li>
                        <li><i class="bx bx-chevron-right"></i> <a href="{{ route('perangkatdesa.user') }}">Perangkat
                                Desa</a>
                        </li>
                    </ul>
                </div>
