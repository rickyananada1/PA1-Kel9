                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.berita.category', $beritacategory->id) }}" method="POST">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Berita Category
                                        Name</label>
                                    <div class="col-sm-10">
                                        <input class="form-control"name="berita_category" type="text"
                                            id="example-text-input" value="{{ $beritacategory->berita_category }}">
