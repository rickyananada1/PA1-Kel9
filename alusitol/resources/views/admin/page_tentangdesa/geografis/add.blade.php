        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Add geografis Desa</h4>
                            <form action="{{ route('store.geografis.desa') }}" method="POST"enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Geografis
                                        Desa</label>
                                    <div class="col-sm-10">
                                        <textarea id="konten" name="geografis">
                                        </textarea>
                                    </div>
                                </div>
                                <input
