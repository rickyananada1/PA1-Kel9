        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Galeri Edit Page</h4>
                            <form action="{{ route('update.galeri') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control"name="galeri_name" value="{{ $galeri->galeri_name }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control"name="galeri_title" type="text"
                                            value="{{ $galeri->galeri_title }}" id="example-text-input">
                                        @error('galeri_title')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
