    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Tentang Desa</h4>
                        <div class="table-responsive">
                            <table class="table table-centered mb-0 align-middle table-hover table-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <a href="{{ route('all.tentang.desa') }}" class="mb-0">View Tentang Desa</a>
                                        </td>
                                        <td>
                                            <span class="avatar-title bg-light text-primary rounded-3">
                                                <a href="{{ route('add.tentang.desa') }}" class="mb-0">Tambahkan</a>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('all.sejarah.desa') }}" class="mb-0">View Sejarah Desa</a>
                                        </td>
                                        <td>
                                            <span class="avatar-title bg-light text-primary rounded-3">
                                                <a href="{{ route('add.sejarah.desa') }}" class="mb-0">Tambahkan</a>
                                                <i class="ri-file-add-line font-size-24"></i>
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="{{ route('all.visimisi.desa') }}" class="mb-0">View Visi Misi</a>
                                        </td>
                                        <td>
                                            <span class="avatar-title bg-light text-primary rounded-3">
                                                <a href="{{ route('add.visimisi.desa') }}" class="mb-0">Tambahkan</a>
                                                <i class="ri-file-add-line font-size-24"></i>
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="{{ route('all.geografis.desa') }}" class="mb-0">View Geografis
                                                Desa</a>
                                        </td>
                                        <td>
                                            <span class="avatar-title bg-light text-primary rounded-3">
                                                <a href="{{ route('add.geografis.desa') }}" class="mb-0">Tambahkan</a>
                                                <i class="ri-file-add-line font-size-24"></i>
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="{{ route('all.perangkat.desa') }}" class="mb-0">View Perangkat
                                                Desa</a>
                                        </td>
                                        <td>
                                            <span class="avatar-title bg-light text-primary rounded-3">
                                                <a href="{{ route('add.perangkat.desa') }}" class="mb-0">Tambahkan</a>
                                                <i class="ri-file-add-line font-size-24"></i>
                                            </span>
                                        </td>
                                    </tr>
