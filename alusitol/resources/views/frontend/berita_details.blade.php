                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8 col-md-10">
                        <div class="breadcrumb__wrap__content">
                            <h2 class="title">{{ $berita->berita_title }}</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                    <li class="breadcrumb-item"><a href="index.html">Berita Details</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ $berita->berita_tags }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="standard__blog__post">
                            <div class="standard__blog__thumb">
                                <img src="{{ asset($berita->berita_image) }}" alt="">
                            </div>
                            <div class="blog__details__content services__details__content">
                                <ul class="blog__post__meta">
                                    <li><i class="fal fa-calendar-alt"></i>
                                        {{ Carbon\Carbon::parse($berita->created_at)->diffForHumans() }}</li>
                                </ul>
                                <h2 class="title">{{ $berita->berita_title }}</h2>
                                <p>{{ $berita->berita_description }}</p>
                            </div>
                            <div class="blog__details__bottom">
                                <ul class="blog__details__tag">
                                    <li class="title">Tag:</li>
                                    <li class="tags-list">
                                        <a href="#">{{ $berita->berita_tags }}</a>
                    ...
                    <div class="col-lg-4">
                        <aside class="blog__sidebar">
                            ...
                            <div class="widget">
                                <h4 class="widget-title">Recent Berita</h4>
                                <ul class="rc__post">
                                    @foreach ($allberita as $all)
                                        <li class="rc__post__item">
                                            <div class="rc__post__thumb">
                                                <a href="blog-details.html"><img src="{{ asset($all->berita_image) }}"
                                                        alt=""></a>
                                            </div>
                                            <div class="rc__post__content">
                                                <h5 class="title"><a
                                                        href="blog-details.html">{{ $all->berita_title }}</a></h5>
                                ...
                                <ul class="sidebar__cat">
                                    @foreach ($categories as $cat)
                                        <li class="sidebar__cat__item"><a
                                                href="{{ route('category.berita', $cat->id) }}">{{ $cat->berita_category }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
