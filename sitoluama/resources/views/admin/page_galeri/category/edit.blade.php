        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Galeri Category Page</h4><br><br>
                            <form action="{{ route('update.galeri.category', $category->id) }}" method="POST">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control"name="galeri_category" type="text"
                                            id="example-text-input" value="{{ $category->galeri_category }}">
                                ...
                                <input
                                    type="submit"class="btn btn-info waves-effect waves-light"value="Updated Galeri Category">
                            </form>
                        </div>
                    </div>
                </div> <!-- end col -->
