                            ...
                            <form action="{{ route('update.tentang.desa') }}" method="POST"enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Tentang
                                        Desa</label>
                                    <div class="col-sm-10">
                                        <textarea id="konten" name="tentangdesa">{!! $tentangdesa->tentangdesa !!}
                                        </textarea>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Visi
                                        Misi</label>
                                    <div class="col-sm-10">
                                        <textarea id="konten2" name="visimisi">{!! $tentangdesa->visimisi !!}
                                        </textarea>
                                    </div>
                                </div>
